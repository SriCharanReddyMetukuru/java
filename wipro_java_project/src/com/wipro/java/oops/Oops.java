...
public class Oops {
    public static void main(String[] args) {
        ...
        LibraryItem book = new Book("Big Bang Theory", "Aultman");  // Inheritance and Polymorphism
        LibraryItem magazine = new Magazine("AI Powerd", 15);  // Inheritance and Polymorphism 
