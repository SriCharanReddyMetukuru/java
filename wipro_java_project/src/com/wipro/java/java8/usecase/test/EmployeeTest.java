...
public class EmployeeTest {
    ...
    public void setUp() {
        ...
        service.addEmployee(new Employee(1, "Charan", "IT", 50000, LocalDate.of(2020, 5, 10)));
        service.addEmployee(new Employee(2, "Reddy", "HR", 45000, LocalDate.of(2019, 3, 15)));
        service.addEmployee(new Employee(3, "Flora", "Finance", 60000, LocalDate.of(2021, 8, 22)));
    }
    ...
    public void testAddEmployee() {
        ...
        assertEquals("Charan", retrieved.get().getName());
    }

    // Test preventing duplicate employees
    @Test
    public void testAddDuplicateEmployee() {
        Employee duplicateEmp = new Employee(1, "charan", "IT", 50000, LocalDate.of(2020, 5, 10));
    ...
    public void testSearchEmployee() {
        ...
        assertEquals("Charan", emp.get().getName());
    }
    ...
    public void testFilterByDepartment() {
        ...
        assertEquals("Reddy", hrEmployees.get(0).getName());
    }
    ...
    public void testSortByName() {
        ...
        assertEquals("Charan", sortedEmployees.get(0).getName());
        assertEquals("Flora", sortedEmployees.get(1).getName());
        assertEquals("Reddy", sortedEmployees.get(2).getName());
    }
